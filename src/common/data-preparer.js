...
export const SEAT_FEATURES_ICONS = {
  ...
  wifi: WIFI_SVG_ICON,
  wifi_enabled: WIFI_SVG_ICON,
  wifiEnabled: WIFI_SVG_ICON,
  power:
  ...
  flexible_cabin:
    '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M7 3.5V0L13 5.83333H2.2V3.5H7ZM1 8.16667H11.8V10.5H7V14L1 8.16667Z" fill="#4f6f8f"/></svg>',
};
