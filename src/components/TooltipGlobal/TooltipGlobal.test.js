...
describe('JetsTooltipGlobal', () => {
  ...
  describe('when a button in the tooltip is pressed', () => {
    it('should fire onSeatSelect when "Select" is pressed', () => {
    ...
    it('should not fire onSeatSelect when seat selection is disabled and "Select" is pressed', () => {
      const onSeatSelect = jest.fn();
    ...
    it('should fire onSeatUnselect when "Unselect" is pressed', () => {
    ...
    it('should not fire onSeatUnselect when the passenger is readOnly and "Unselect" is pressed', () => {
      const onSeatUnselect = jest.fn();
    ...
    it('should fire onTooltipClose when "Cancel" is pressed', () => {
