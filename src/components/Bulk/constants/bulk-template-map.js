...
BULK_TEMPLATE_MAP.set(
  '29',
  `
  <svg id="bulk-29" viewBox="0 0 282 379" xmlns="http://www.w3.org/2000/svg">
    <path class="bulk-base" fill="$baseColor" d="M0,255v109c0,8.28,6.72,15,15,15,.03,0,.05,0,.08,0h251.84c8.28.04,15.04-6.64,15.08-14.92,0-.03,0-.05,0-.08v-109H0Z"/>
    <path class="bulk-cut" fill="$cutColor" d="M116.1,97.51L60.14,0H16.79C7.53-.01.01,7.49,0,16.75h0v237.25c0,9.31,7.48,16.89,16.79,17h248.42c9.31-.11,16.79-7.69,16.79-17V16.75c-.01-9.26-7.53-16.76-16.79-16.75h-43.66l-55.71,97.47c-11.51,18.32-38.2,18.34-49.74.03Z"/>
    <path class="icon bulk" fill="$stickerColor" d="M207.05,242.69h-57.94c-4.59,0-8.31-3.73-8.31-8.31v-57.94c0-4.59,3.73-8.31,8.31-8.31h57.94c4.59,0,8.31,3.73,8.31,8.31v57.94c0,4.59-3.73,8.31-8.31,8.31ZM149.1,169.98c-3.54,0-6.45,2.91-6.45,6.45v57.94c0,3.54,2.91,6.45,6.45,6.45h57.94c3.54,0,6.45-2.91,6.45-6.45v-57.94c0-3.54-2.91-6.45-6.45-6.45h-57.94ZM201.9,215.24c0,.37.11,2.5-1.16,2.5h-44.97c-1.23,0-1.08-2.13-1.08-2.46s-.11-2.46,1.08-2.46h44.97c1.27-.07,1.16,2.09,1.16,2.42ZM201.83,205.56v-5.22c0-5.29-4.29-9.58-9.58-9.58h-15.48c-1.42,0-2.57,1.16-2.57,2.57v12.23c0,1.42,1.16,2.57,2.57,2.57h22.49c1.42.04,2.57-1.12,2.57-2.57ZM162.3,193.33c-4.1,0-7.42,3.32-7.42,7.42s3.32,7.42,7.42,7.42,7.42-3.32,7.42-7.42-3.32-7.42-7.42-7.42Z"/>
    <path class="icon bulk" fill="$stickerColor" d="M132.27,242.69h-59.38c-4.7,0-8.52-3.73-8.52-8.31v-57.94c0-4.59,3.82-8.31,8.52-8.31h59.38c4.7,0,8.52,3.73,8.52,8.31v57.94c0,4.59-3.82,8.31-8.52,8.31ZM72.88,169.98c-3.63,0-6.61,2.91-6.61,6.45v57.94c0,3.54,2.98,6.45,6.61,6.45h59.38c3.63,0,6.61-2.91,6.61-6.45v-57.94c0-3.54-2.98-6.45-6.61-6.45h-59.38ZM126.99,215.24c0,.37.11,2.5-1.18,2.5h-46.08c-1.26,0-1.11-2.13-1.11-2.46s-.11-2.46,1.11-2.46h46.08c1.3-.07,1.18,2.09,1.18,2.42ZM126.92,205.56v-5.22c0-5.29-4.39-9.58-9.82-9.58h-15.87c-1.45,0-2.64,1.16-2.64,2.57v12.23c0,1.42,1.18,2.57,2.64,2.57h23.05c1.45.04,2.64-1.12,2.64-2.57ZM86.41,193.33c-4.2,0-7.6,3.32-7.6,7.42s3.4,7.42,7.6,7.42,7.6-3.32,7.6-7.42-3.4-7.42-7.6-7.42Z"/>
  </svg>
  `
);
